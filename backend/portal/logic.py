...
def get_user_info(user):
    ...
    return {
        ...
        "groups": ["employee", "student", "member"],
        "product_permission": [],
        "user_permissions": [],
        "student": {
            "major": [{"id": 192, "name": "Finance, BS", "degree_type": "BACHELORS"}],
            "school": [{"id": 12, "name": "The Wharton School"}],
            "graduation_year": 2025,
        },
        "phone_numbers": [],
        "emails": [
            {"id": 24213, "value": "arnavc@wharton.upenn.edu", "primary": True, "verified": True}
        ],
        "profile_pic": None,
    }
