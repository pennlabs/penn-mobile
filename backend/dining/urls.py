...
urlpatterns = [
    ...
    path("menus/", Menus.as_view(), name="menus"), #  cache_page(3 * Cache.HOUR)(Menus.as_view())
    path("menus/<date>/", Menus.as_view(), name="menus-with-date"), # cache_page(3 * Cache.HOUR)(Menus.as_view())
