...
class LeaderboardEntry(models.Model):
    ...
    class Meta:
        constraints = [models.UniqueConstraint(fields=["game", "user"], name="unique_entry_per_user_per_game")]
        # Order is based on descending order of score. If tiebreaker, the one with lower number of words win.
        # If they also tie in that, then we sort by submitted time (NEED TO FIX).
