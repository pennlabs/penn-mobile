    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorites', models.ManyToManyField(blank=True, related_name='sublets_favorited', through='sublet.Favorite', to=settings.AUTH_USER_MODEL)),
                ('sublettees', models.ManyToManyField(blank=True, related_name='sublets_offered', through='sublet.Offer', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='favorite',
            name='sublet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sublet.sublet'),
        ),
        migrations.AddField(
            model_name='favorite',
            name='user',
